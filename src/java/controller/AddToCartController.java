...
public class AddToCartController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String productIdToRemove = request.getParameter("removeItem");
        if (productIdToRemove != null && !productIdToRemove.isEmpty()) {
            // Remove the product from the shopping cart
            int productCartId = Integer.parseInt(productIdToRemove);
            ShoppingCartItemDAO spcDAO = new ShoppingCartItemDAO();
            spcDAO.removeProductFromShoppingCart(productCartId, user.getId());
        } else {
