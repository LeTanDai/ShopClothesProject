                            ...
                            <div class="tile">
                                ...
                                <div>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <c:forEach var="orderid" items="${orderidsorted}">
                                                <c:set var="order" value="${oDao.getOrderbyOrderid(orderid)}"/>
                                                <c:set var="s" value="${mapOrder.get(order)}" />
                                                <tr>
                                                    <td>${order.id}</td>
                                                    <td>${order.date}</td>
                                                    <td>${order.status}</td>
