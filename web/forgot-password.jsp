...
<div id="logreg-forms">
            <form class="form-signin" action="forgotPassword" method="post">
                ...
                <input name="repeatpassword" type="password" class="form-control" placeholder="Password" required="" autofocus="">
                <button class="btn btn-success btn-block" type="submit"><i class="fas fa-sign-in-alt"></i> Reset</button> 
            </form>
